 ...
 * Se restaura el comportamiento nativo del RootMenu para que el clic
 * en el escritorio no abra Pymenu. Pymenu queda disponible desde el
 * botón del panel y los atajos configurados en example.jwmrc.
 */
